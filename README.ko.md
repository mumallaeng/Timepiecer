...
| 이름 | 담당 |
| --- | --- |
| 김⁠연⁠우 ([@mumallaeng](https://github.com/mumallaeng)) | **Timepiece 설계·구현·검증**: timepiece_fsm, timepiece_datapath, time_set_module, timepiecer |
| 이⁠영⁠현 ([@younghyun0702](https://github.com/younghyun0702)) | **Timer 설계·구현·검증**: debouncer, input_conditioning, timer_fsm, timer_datapath, timer_unit |
